        ...
        <div className={cx("product-catalog")}>
          ...
          <div className={cx("product-list")}>
            <div className={cx("list-product")}>
              ...
              <div className={cx("product-box01")}>
                <div className={cx("text-product-box01")}>
                  <a className={cx("text-box01")}>Áo sơ mi dài</a>
                </div>
                <div>
                  <img
                    className={cx("img-product")}
              ...
              <div className={cx("product-box01")}>
                <div className={cx("text-product-box01")}>
                  <a className={cx("text-box01")}>Quần Jogger</a>
                </div>
                <div>
                  <img
                    className={cx("img-product")}
              ...
              <div className={cx("product-box01")}>
                <div className={cx("text-product-box01")}>
                  <a className={cx("text-box01")}>Quần Short</a>
                </div>
                <div>
                  <img
                    className={cx("img-product")}
              ...
              <div className={cx("product-box01")}>
                <div className={cx("text-product-box01")}>
                  <a className={cx("text-box01")}>Quần Jeans</a>
                </div>
                <div>
                  <img
                    className={cx("img-product")}
        ...
        <div className={cx("section02")}>
          ...
          <div className={cx("list-sanpham")}>
            <div className={cx("production")}>
              <div className={cx("product")} href="/collection/product">
          ...
          <div className={cx("list-sanpham")}>
            <div className={cx("production")}>
              <div className={cx("product")}>
                ...
                <div className={cx("text-product")} href="/collection/product">
                  <div className={cx("title-product")}>
