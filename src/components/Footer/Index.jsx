      ...
      <div className={cx("inner")}>
        <div className={cx("content")}>
          <div className={cx("cl01")}>
            <h1 className={cx("title")}>CÔNG TY CỔ PHẦN THỜI TRANG BADBOY</h1>
            <p className={cx("text")}>
              Địa chỉ: Số 1, ngõ 40, tổ 14 phố Nguyễn Thị Định, Phường Nhân
              Chính, Quận Thanh Xuân, Hà Nội
            </p>
            <p className={cx("text")}>Người Đại Diện: Nguyễn Thái Sơn</p>
            <p className={cx("text")}>
              Mã số thuế: 0106533311, ngày cấp ĐKKD 08/05/2014.
            </p>
            <p className={cx("text")}>Nơi cấp: Sở kế hoạch và đầu tư Hà Nội.</p>
            <img
          ...
          <div className={cx("cl01")}>
            ...
            <p className={cx("text")}>Tất cả các ngày trong tuần </p>
