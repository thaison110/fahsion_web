...
function Product() {
    ...
    useEffect(() => {
        ...
        setFormData({ ...formData, user_id: user_id, product_id: id_ });
        // Gửi yêu cầu GET đến API để lấy thông tin sản phẩm dựa trên ID
        axios
            .get(`http://localhost:1099/api/product${id_}`)
            .then((response) => {
    ...
    const createOrder = async () => {
        try {
            ...
            const response = await axios.post(
                "http://localhost:1099/api/orders",
                { ...formData, quantity: 1, price: product.price }
            );
                        ...
                        <div className={cx("right")}>
                            <div className={cx("right-text")}>
                                <div>
                                    ...
                                    <div>
                                        <Link>Hướng dẫn kích thước</Link>
                                        <div className={cx("color")}>
                                            <div className={cx("text-color")}>
                                                <p>Số Lượng:</p>
                                            </div>
                            ...
                            <div className={cx("cmt-text")}>
                                <div className={cx("right01")}>
                                    ...
                                    <p className={cx("comment")}>
                                        Shop giao hàng nhanh, sản phẩm mặc lên
                                        form đẹp cực
                                    </p>
                                </div>
                            </div>
